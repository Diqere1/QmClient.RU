...
MACRO_CONFIG_INT(Bc3DParticles, bc_3d_particles, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "启用 BestClient 风格背景 3D 粒子")
MACRO_CONFIG_INT(Bc3DParticlesType, bc_3d_particles_type, 1, 1, 3, CFGFLAG_CLIENT | CFGFLAG_SAVE, "背景 3D 粒子类型：1=方块，2=爱心，3=混合")
MACRO_CONFIG_INT(Bc3DParticlesCount, bc_3d_particles_count, 45, 1, 200, CFGFLAG_CLIENT | CFGFLAG_SAVE, "背景 3D 粒子数量")
MACRO_CONFIG_INT(Bc3DParticlesSpeed, bc_3d_particles_speed, 18, 1, 500, CFGFLAG_CLIENT | CFGFLAG_SAVE, "背景 3D 粒子基础速度")
MACRO_CONFIG_INT(Bc3DParticlesSizeMin, bc_3d_particles_size_min, 4, 2, 64, CFGFLAG_CLIENT | CFGFLAG_SAVE, "背景 3D 粒子最小尺寸")
MACRO_CONFIG_INT(Bc3DParticlesSizeMax, bc_3d_particles_size_max, 10, 2, 64, CFGFLAG_CLIENT | CFGFLAG_SAVE, "背景 3D 粒子最大尺寸")
MACRO_CONFIG_INT(Bc3DParticlesDepth, bc_3d_particles_depth, 300, 10, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "背景 3D 粒子深度范围")
MACRO_CONFIG_INT(Bc3DParticlesViewMargin, bc_3d_particles_view_margin, 120, 0, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "背景 3D 粒子视野外保留边距")
MACRO_CONFIG_INT(Bc3DParticlesAlpha, bc_3d_particles_alpha, 30, 1, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "背景 3D 粒子透明度")
MACRO_CONFIG_INT(Bc3DParticlesFadeInMs, bc_3d_particles_fade_in_ms, 400, 1, 5000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "背景 3D 粒子淡入时间")
MACRO_CONFIG_INT(Bc3DParticlesFadeOutMs, bc_3d_particles_fade_out_ms, 400, 1, 5000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "背景 3D 粒子淡出时间")
MACRO_CONFIG_INT(Bc3DParticlesCollide, bc_3d_particles_collide, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "背景 3D 粒子之间碰撞")
MACRO_CONFIG_INT(Bc3DParticlesPushRadius, bc_3d_particles_push_radius, 120, 0, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "玩家推动背景 3D 粒子的半径")
MACRO_CONFIG_INT(Bc3DParticlesPushStrength, bc_3d_particles_push_strength, 120, 0, 2000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "玩家推动背景 3D 粒子的强度")
MACRO_CONFIG_INT(Bc3DParticlesColorMode, bc_3d_particles_color_mode, 1, 1, 2, CFGFLAG_CLIENT | CFGFLAG_SAVE, "背景 3D 粒子颜色模式：1=自定义，2=随机")
MACRO_CONFIG_COL(Bc3DParticlesColor, bc_3d_particles_color, 0xFF8FB89E, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "背景 3D 粒子自定义颜色")
MACRO_CONFIG_INT(Bc3DParticlesGlow, bc_3d_particles_glow, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "启用背景 3D 粒子辉光")
MACRO_CONFIG_INT(Bc3DParticlesGlowAlpha, bc_3d_particles_glow_alpha, 35, 1, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "背景 3D 粒子辉光透明度")
MACRO_CONFIG_INT(Bc3DParticlesGlowOffset, bc_3d_particles_glow_offset, 2, 1, 20, CFGFLAG_CLIENT | CFGFLAG_SAVE, "背景 3D 粒子辉光偏移")
