...
- Windows 上默认通过 `qmclient_scripts/cmake-windows.cmd` 进入 CMake；只有已确认当前 shell 已注入 MSVC 环境时，才可直接裸跑 `cmake`
- macOS 安装名修正
- OpenSSL 相关本地构建辅助
...
- `python qmclient_scripts/gate/tools/refresh_allowlist.py`
